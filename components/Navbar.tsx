  ...
  return (
    <motion.nav
      ...
      className={`fixed top-0 left-0 w-full z-50 transition-all duration-300 ${
        scrolled ? 'bg-brand-dark/90 backdrop-blur-lg border-b border-brand-primary/20' : 'bg-transparent'
      }`}
    >
      <div className="container mx-auto px-6 py-4 flex justify-between items-center">
        <a href="#" className="text-2xl font-display font-bold text-white tracking-wider flex items-center gap-1">
          <span className="text-brand-primary drop-shadow-[0_0_8px_rgba(242,101,34,0.8)]">VIDA</span>DIGITAL
        </a>
        ...
        <div className="hidden md:flex items-center space-x-8">
          ...
          <a 
            href="https://tienda.vidadigitalec.com/" 
        ...
        >
          {isOpen ? <X size={28} className="text-brand-primary" /> : <Menu size={28} />}
        </button>
      </div>
